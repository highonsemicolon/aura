...
help:
	...
	@echo "  ensure-dev-tools Ensure required dev tools are installed"
	...
	@command -v golang-migrate > /dev/null || { echo "Installing golang-migrate..."; go install -tags 'mysql' github.com/golang-migrate/migrate/v4/cmd/migrate@latest; }
